<?php
echo <<< END
<select name="egoi_mail_list_builder_mobileext_text" id="egoi_mail_list_builder_mobileext_text">
	...
	<option value="290" >Saint Helena, Tristan da Cunha (+290)</option>
	...
	<option value="599" >Sint Maarten (Dutch part) (+599)</option>
	<option value="42" >Slovakia (+42)</option>
